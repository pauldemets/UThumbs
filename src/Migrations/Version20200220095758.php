 ...
 */
final class Version20200220095758 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE waiting_user CHANGE accept_walker accept_walker TINYINT(1) DEFAULT NULL');
